...
const getOrCreateZernioProfile = async (user:any) : Promise<string> => {
    try {
        ...
        console.error("getOrCreateZernioProfile", error?.message || error);
        throw error;
    }
}
...
export const syncAccounts = async (req: AuthRequest, res: Response) : Promise<void>=>{
    try {
        ...
        const supportedPlatforms = await ["twitter", "linkedIn", "facebook", "instagram"];
