...
const Scheduler = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-6 h-full" onSubmit={handleSchedule}>
            {/* Composed panel */}
                                    ...
                                    <div className="flex items-center justify-between mb-2">
                                        <div className="flex gap-1.5 items-center">
                                            {post.platforms.map((pl: string)=>{
                                                ...
                                                return meta ? <meta.icon key={pl} clasName="size-3.5 text-slate-400" /> : null;
                                            })}
                                        </div>
